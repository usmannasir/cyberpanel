...
newapp.controller('deleteDNSZoneV2', function ($scope, $http) {
...
newapp.controller('configureDefaultNameserversV2', function ($scope, $http) {
...
newapp.controller('addModifyDNSRecordsV2', function ($scope, $http) {

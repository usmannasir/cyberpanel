...
class secMiddleware:
    ...
    def __call__(self, request):
        ...
        response['Content-Security-Policy'] = "script-src 'self' https://www.jsdelivr.com https://cdn.jsdelivr.com"
        response['Content-Security-Policy'] = "connect-src *;"
        response['Content-Security-Policy'] = "font-src 'self' 'unsafe-inline' https://www.jsdelivr.com https://cdn.jsdelivr.com https://fonts.googleapis.com"

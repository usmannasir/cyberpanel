...
Ubuntu 22.04, Ubuntu 24.04, and Ubuntu 26.04 installation paths have been
exercised during the 3.0 release series. The final candidate received a clean
Ubuntu 26.04 install, remote-database upgrade, reboot, service, WordPress, SSL,
native-webmail, and authenticated browser pass. Existing local-database
installations retain their established configuration.

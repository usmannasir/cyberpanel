...
_CYBERPANEL_VENV_DIR="$(cd "$(dirname "${BASH_SOURCE[0]:-$0}")" && pwd)"
if [[ -f "${_CYBERPANEL_VENV_DIR}/cyberpanel_ssh_login_banner.sh" ]]; then
  # shellcheck source=/dev/null
  source "${_CYBERPANEL_VENV_DIR}/cyberpanel_ssh_login_banner.sh"

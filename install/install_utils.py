...
def cyberpanel_github_owner():
    """GitHub org/user for CyberPanel source (installer exports CYBERPANEL_GIT_USER or CYBERPANEL_GITHUB_OWNER)."""
    owner = (os.environ.get('CYBERPANEL_GIT_USER') or os.environ.get('CYBERPANEL_GITHUB_OWNER') or 'usmannasir').strip()

...
readarray -t datetimeDcpumonLast5_array < <(printf '%s\n' "$(date +"%Y/%b/%d")" "$(date --date='1 day ago' +"%Y/%b/%d")" "$(date --date='2 days ago' +"%Y/%b/%d")" "$(date --date='3 days ago' +"%Y/%b/%d")" "$(date --date='4 days ago' +"%Y/%b/%d")")	user_homedir="/home/${Username}"
	# shellcheck disable=SC2034
...
readarray -t datetimeDomLast5_array < <(printf '%s\n' "$(date +"%d/%b/%Y")" "$(date --date='1 day ago' +"%d/%b/%Y")" "$(date --date='2 days ago' +"%d/%b/%Y")" "$(date --date='3 days ago' +"%d/%b/%Y")" "$(date --date='4 days ago' +"%d/%b/%Y")")

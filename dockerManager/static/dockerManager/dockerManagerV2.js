var delayTimer = null;
newapp.controller('manageImagesV2', function ($scope, $http) {
    $scope.tagList = [];
        ...
        (new PNotify({
            ...
            function ListInitialData(response) {
                ...
                if (response.data.removeImageStatus === 1) {
                    ...
                    window.location.href = "/docker/V2/manageImagesV2";
                } else {
                    new PNotify({
                        title: 'Unable to complete request',
                        text: response.data.error_message,
...
newapp.controller('listContainersV2', function ($scope, $http) {
    $scope.activeLog = "";
    $scope.assignActive = "";
...
newapp.controller('runContainerV2', function ($scope, $http) {
...
newapp.controller('viewContainerV2', function ($scope, $http) {
    $scope.cName = "";
    $scope.status = "";

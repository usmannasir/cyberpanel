...
# Do not stage errorSanitizer.py next to upgrade.py: that copy imports Django
# and CyberCPLogFileWriter, which stock trees do not provide. upgrade.py has
# a fallback ErrorSanitizer stub for this case.

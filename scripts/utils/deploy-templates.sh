...
for name in modifyUser createUser; do
    SRC="$REPO_ROOT/userManagment/templates/userManagment/${name}.html"
...
if [ -f "$REPO_ROOT/loginSystem/templates/loginSystem/login.html" ]; then
    cp -f "$REPO_ROOT/loginSystem/templates/loginSystem/login.html" \
...
if [ -f "$REPO_ROOT/userManagment/static/userManagment/userManagment.js" ]; then
    mkdir -p "$CYBERCP_ROOT/userManagment/static/userManagment"
    cp -f "$REPO_ROOT/userManagment/static/userManagment/userManagment.js" \
          "$CYBERCP_ROOT/userManagment/static/userManagment/userManagment.js"
    echo "  Copied userManagment.js"
fi
if [ -f "$REPO_ROOT/loginSystem/static/loginSystem/webauthn.js" ]; then
    mkdir -p "$CYBERCP_ROOT/loginSystem/static/loginSystem"
    cp -f "$REPO_ROOT/loginSystem/static/loginSystem/webauthn.js" \

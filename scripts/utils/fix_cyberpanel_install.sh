...
# LEGACY: CyberPanel post-upgrade / incomplete-install recovery script.
# Prefer: cyberpanel-utils.sh run fix-cyberpanel-install (same file).
# Completes installation when upgrade exits early (venv, lswsgi, lscpd).

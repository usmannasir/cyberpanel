...
newapp.controller('deleteEmailAccountV2', function ($scope, $http) {
...
newapp.controller('changeEmailPasswordV2', function ($scope, $http) {
...
newapp.controller('dkimManagerV2', function ($scope, $http, $timeout, $window) {
...
newapp.controller('emailForwardingV2', function ($scope, $http) {

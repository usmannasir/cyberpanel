newapp.controller('firewallControllerV2', function ($scope, $http) {
...
newapp.controller('secureSSHCTRLV2', function ($scope, $http) {
...
newapp.controller('modSecRulesV2', function ($scope, $http) {
...
newapp.controller('modSecV2', function ($scope, $http, $timeout, $window) {
...
newapp.controller('modSecRulesPackV2', function ($scope, $http, $timeout, $window) {
...
newapp.controller('csfV2', function ($scope, $http, $timeout, $window) {
...
newapp.controller('installImunifyV2', function ($scope, $http, $timeout, $window) {
...
newapp.controller('installImunifyAVV2', function ($scope, $http, $timeout, $window) {

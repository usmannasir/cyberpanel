...
//		\header('Permissions-Policy: interest-cohort=()');
		...
		// LiteSpeed (and some HTTP/2 front ends) mishandle raw "/" inside the query string; clients may send %2F instead.
		if (\str_contains($sQuery, '%2F')) {
			$sQuery = \rawurldecode($sQuery);
		}
